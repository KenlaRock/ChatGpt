...
- Open `test/ai-gate-live-scope-violation-20260711` from `main@2f49d16153d2baca8b36cec6286b27e43262d081` with valid proof/control records but an intentionally undeclared root-level `dummy-file.md`.
